...
//	setFixedWidth(250);
    ...
    m_pctrlWindspeed = new QLabel(tr("Wind Speed [m/s]"));
    ...
    SimuShow->addWidget(m_pctrlWindspeed,0,2);
    SimuShow->addWidget(m_pctrlWindspeedVal,0,3);
...
//    SimuShow->addWidget(m_pctrlWindprofileVal,7,3);
    ...
    m_pctrlLSLineEdit->setMinimum(0.0);
    ...
    ExportCharSim = new QPushButton("Export Simulation Data");
    ...
    CharLayout->addWidget(ExportCharSim);
...
void SimuWidgetDMS::Connect()
{
    ...
    connect(ExportCharSim, SIGNAL(clicked()), this, SLOT(OnExportCharSim()));
...
void SimuWidgetDMS::OnExportCharSim()
{
    QDMS *pDMS = (QDMS *) m_pDMS;

    pDMS->OnExportCharacteristicSimulation();
}
