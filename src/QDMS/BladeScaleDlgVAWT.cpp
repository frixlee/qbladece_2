...
{
        m_pctrlUnit20->setText("m");
        m_pctrlUnit21->setText("m");
        m_pctrlUnit22->setText("m");
        m_pctrlUnit23->setText("m");
        ...
        strong = QString("%1").arg(m_RefSpan,8,'f',3);
        m_pctrlRefSpan->setText(strong);

        strong = QString("%1").arg(m_RefShift,8,'f',3);
        m_pctrlRefShift->setText(strong);

        strong = QString("%1").arg(m_RefChord,8,'f',3);
        m_pctrlRefChord->setText(strong);

        strong = QString("%1").arg(m_RefOffset,8,'f',3);
        m_pctrlRefOffset->setText(strong);

        strong = QString("%1").arg(-(m_RefTwist-90),8,'f',2);
        m_pctrlRefTwist->setText(strong);

        m_pctrlNewSpan->setValue(m_NewSpan);
        m_pctrlNewShift->setValue(m_NewShift);
        m_pctrlNewChord->setValue(m_NewChord);
        m_pctrlNewOffset->setValue(m_NewOffset);
...
void BladeScaleDlgVAWT::ReadData()
{
        ...
        m_NewSpan  = m_pctrlNewSpan->getValue();
        m_NewShift = m_pctrlNewShift->getValue();
        m_NewChord = m_pctrlNewChord->getValue();
        m_NewOffset = m_pctrlNewOffset->getValue();
