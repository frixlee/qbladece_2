                            ...
                            ,double SparDensity)//Positive angle gives clockwise rotation
{
    ...
    Eigen::Rotation2D<double> Rotation((Angle*2*PI_)/360.0);
...
void StructElem::TotalStruct()
{
    ...
    Total.IX = Outer.IX-Inner.IX+Spar.IX;
    Total.IY = Outer.IY-Inner.IY+Spar.IY;
    Total.J = Outer.J-Inner.J+Spar.J;
    ...
    Total.Area = (Outer.Area - Inner.Area + Spar.Area);
}
...
//    std::cout<<"Alpha(deg)="<<alpha*180.0/PI_<<std::endl;
...
void StructElem::PrintProperties()
{
	...
	std::cout<<"Structural Twist ="<<StructuralTwist*180.0/PI_<<std::endl;
