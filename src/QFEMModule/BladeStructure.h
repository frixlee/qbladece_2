...
public:
    ...
    void writeFASTBladeFile(QString &fileName);
    void writeFASTTowerFile(QString &fileName);
    void writeQBladeStructFile(QString &fileName);
    ...
    QVector<double> Ix;/**< Moment of stiffness inertia y direction(reference coordinate system)*/
    QVector<double> Iy;/**< Moment of stiffness inertia y direction(reference coordinate system)*/
    QVector<double> J;/**< Moment of stiffness inertia y direction(reference coordinate system)*/
    QVector<double> Area;/**< Moment of stiffness inertia y direction(reference coordinate system)*/
    ...
    QVector<double> CenY; /**< x distance from reference coordinate system to the centroid*/
    QVector<double> CenX; /**< y distance from reference coordinate system to the centroid*/
    QVector<double> Xe; /**< x distance from reference coordinate system to the point of elasticity*/
    QVector<double> Ye; /**< y distance from reference coordinate system to the point of elasticity*/
