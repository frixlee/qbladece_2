...
#ifndef WAVETWODCONTEXTMENU_H
#define WAVETWODCONTEXTMENU_H

#include "../TwoDContextMenu.h"
class WaveModule;

class WaveTwoDContextMenu : public TwoDContextMenu
{
public:
    WaveTwoDContextMenu(QWidget *parent, WaveModule *module);
